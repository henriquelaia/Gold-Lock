...
Este capítulo descreve os testes realizados para avaliar o sistema FinTwin em três dimensões: usabilidade (testes com utilizadores reais), performance técnica e precisão do módulo de \ac{ML}. A avaliação segue as métricas definidas nos requisitos não-funcionais (Secção~\ref{sec:req-nao-funcionais}).
